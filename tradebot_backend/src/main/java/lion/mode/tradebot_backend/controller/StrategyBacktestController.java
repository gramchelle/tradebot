...
public class StrategyBacktestController {
    ...
    /* ----------------- Indicator Based Strategies' Backtest Endpoints ----------------- */
    ...
    public ResponseEntity<StrategyBacktestDto> backtestBollingerBands(
        ...
        return new ResponseEntity<>(strategyService.runBollingerBandsStrategyBacktest(symbol, source, stopLoss, takeProfit, period, stdDevMultiplier, isTrailingStopLoss, lookback), HttpStatus.OK);
    }
