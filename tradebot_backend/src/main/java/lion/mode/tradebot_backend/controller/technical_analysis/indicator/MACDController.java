...
import lion.mode.tradebot_backend.dto.indicator.MACDResult;
...
public class MACDController {
    ...
    public ResponseEntity<MACDResult> getMacdAt(
        ...
        return new ResponseEntity<>(
                macdService.calculateMacd(symbol, shortPeriod, longPeriod, signalPeriod, date, histogramTrendPeriod, histogramConfidence, priceType), HttpStatus.OK);
    }
}