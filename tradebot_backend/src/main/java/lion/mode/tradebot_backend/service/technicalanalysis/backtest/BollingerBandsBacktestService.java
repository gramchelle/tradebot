...
public class BollingerBandsBacktestService extends AbstractBacktestService {
    ...
    public BaseBacktestResponse runBacktest(BollingerBandsEntry entry, int lookback, int horizon, String timeInterval, double takeProfit, double stopLoss, int tradeAmount) {
        ...
        for (int i = startIndex; i <= targetIndex; i += horizon) {
            ...
            // Create BollingerBandsEntry entry for this specific date/index
    ...
    public boolean saveIndicatorBacktest(BollingerBandsEntry entry, int lookback, int horizon, String timeInterval, double takeProfit, double stopLoss, int tradeAmount) {
